...
from .models import Ingredient, Recipe, User, timezone
...
class RecipeTest(TestCase):
    ...
    def test_recipe_creation(self):
        ...
        self.assertTrue(isinstance(r.ingredients.get(name="test_ingredient"), Ingredient)) #tester at r.ingredients inneholder ingrediensen vi ga den og at det er en ingrediens
        ...
        self.assertLessEqual(r.date_posted, timezone.now()) #tester at tiden r ble laget er nå eller før(siden vi kan teste over et minuttskifte)
